...
public class Reservation {
    ...
    // Constructeurs, getters, setters, d'autre méthodes

    public Reservation() {
    }

    public Reservation(LocalDateTime dateDebut, LocalDateTime dateFin, String motif, Salle salle, Utilisateur utilisateur) {
        this.dateDebut = dateDebut;
        this.dateFin = dateFin;
        this.motif = motif;
        this.salle = salle;
